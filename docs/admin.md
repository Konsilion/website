...
[Accueil du site]({{ katalog_site }}/pages/accueil){ .md-button .md-button--primary style="float:left; margin: 10px; padding: 5px 15px;" target="_self"}

[Votre répertoire]({{ katalog_repo }}){ .md-button .md-button--primary style="float:left; margin: 10px; padding: 5px 15px;" target="_blank"}
